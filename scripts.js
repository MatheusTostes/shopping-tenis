...
const filterMark = (mark) => {
  ...
  shoesList.map((shoes) => {
    if (shoes.mark === mark) {
      const dynamicLink = `https://api.whatsapp.com/send?phone=555197428101&text=Ol%C3%A1,%20tenho%20interesse%20no%20produto%20de%20id:%20${shoes.id},%20na%20categoria%20${shoes.mark}.%20Imagem:%20https://shopping-tenis.vercel.app/shoes/${shoes.id}.jpeg`
      const item = 
      `
